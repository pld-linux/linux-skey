...
Ten pakiet zawiera linuksową wersję aplikacji pakietu S/Key.
...
Ten pakiet zawiera linuksową wersję modułów PAM pakietu S/Key.
...
Pliki nagłówkowe, biblioteka statyczna i dokumentacja do linux-skey.
